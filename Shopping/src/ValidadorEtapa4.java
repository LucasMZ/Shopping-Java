...
public class ValidadorEtapa4 {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
				...
				//instância
				Data d1 = new Data(10, 3, 2023,2003);
				...
				System.out.println(d1.verificaAnoBissexto(2023) ? "[OK] Método Dia.verificaAnoBissexto()" : "[NOK] Método Dia.verificaAnoBissexto()");
				...
				p1.setDataValidade(new Data(10, 4, 2023, 0));
				System.out.println("[OK] Método Produto.setDataValidade()");
				
				//public double getDataValidade();
				System.out.println(p1.getDataValidade() != 0 ? "[OK] Método Produto.getDataValidade()" : "[NOK] Método Produto.getDataValidade()");
				
				//public boolean estaVencido(Data data);
				System.out.println(p1.estaVencido(new Data(20, 4, 2023, 0)) ? "[OK] Método Produto.estaVencido()" : "[NOK] Método Produto.estaVencido()");
				...
				Loja loja2 = new Loja ("E7", 20, 2000, e1, d1,false);
				...
				loja1.setDataFundacao(new Data(10, 8, 2020, 0));
				...
				boolean prod1 = loja2.insereProduto(new Produto("Pipoca doce", 5, new Data(10,5,2023, 0)));
				...
				boolean prod2 = loja2.insereProduto(new Produto("Pipoca salgada", 4, new Data(15,5,2023, null)));
				...
				boolean prod3 = loja2.insereProduto(new Produto("Pipoca caramelo", 5, new Data(12,5,2023, null)));
				...
				boolean rem2 = loja2.removeProduto("Pipoca caramelo");
