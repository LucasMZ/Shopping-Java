...
public class ValidadorEtapa4 {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
				...
				System.out.println(p1.getDataValidade(0) != 0 ? "[OK] Método Produto.getDataValidade()" : "[NOK] Método Produto.getDataValidade()");
				...
				Loja loja1 = new Loja ("E3", 5, null, 0, e1, d1, 5);
				System.out.println("\n[OK] Classe Loja identificada (construtor com cinco parâmetros)");
				
				Loja loja2 = new Loja ("E7", 20, null, 2000, e1, d1, 2);
